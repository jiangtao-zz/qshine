	...
	public class Group : SqlDDLTable
	{
			...
			: base("im_group", "IDM", "User group table.", "idmData", "idmIndex")
		{
			AddPKColumn("id", System.Data.DbType.Int64)
				...
				.AddColumn("group_name", System.Data.DbType.String, 150, allowNull: false, comments: "group name", isUnique: true, isIndex: true)
				.AddColumn("description", System.Data.DbType.String, 500, comments: "group detail description")
				.AddAuditColumn();
		}
	}
}
