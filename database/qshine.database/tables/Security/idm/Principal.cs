	...
	public class Principal : SqlDDLTable
	{
			...
			: base("im_principal", "IDM", "Principal table.", "idmData", "idmIndex")
		{
			AddPKColumn("id", System.Data.DbType.Int64)
				...
				.AddColumn("principal_type", System.Data.DbType.Int16, 0, comments: "principal type:1-user,2-group, 3-role")
				.AddColumn("source_id", System.Data.DbType.Int64, 0, comments: "principal source table id. It could be user id, group id or role id.")
				.AddAuditColumn();
		}
	}
}
