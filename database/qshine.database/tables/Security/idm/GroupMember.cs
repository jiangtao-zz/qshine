	...
	public class GroupMember : SqlDDLTable
	{
			...
			: base("im_group_member", "IDM", "Group member table. A group member could be a sub-group or a user.", "idmData", "idmIndex")
		{
			AddPKColumn("id", System.Data.DbType.Int64)
				...
				.AddColumn("principal_id", System.Data.DbType.Int64, 0, false, comments: "principal id. It only can be user id or group id.", isIndex: true, reference:"im_principal:id")
				.AddColumn("group_id", System.Data.DbType.Int64, 0, false, comments: "group id", isIndex: true, reference:"im_group:id")
				.AddAuditColumn();
		}
	}
}
