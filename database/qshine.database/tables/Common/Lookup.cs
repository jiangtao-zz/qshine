	...
	public class Lookup:SqlDDLTable
	{
			...
			: base("cm_lookup", "COMMON", "Lookup and Reference data table.", "comData", "comIndex")
		{
			AddPKColumn("id", System.Data.DbType.Int64)
				...
				.AddColumn("lookup_type", System.Data.DbType.String, 150, allowNull: false, comments: "Defines a type of lookup that the code applied. ")
				.AddColumn("lookup_code", System.Data.DbType.String, 150, allowNull: false, comments: "Defines a unique code or key for particular lookup type.")
				.AddColumn("lookup_value", System.Data.DbType.String, 250, comments: "Lookup detail description. For multi-lingual support, other language description could be found in language 'lg_dictionary' table.")
				.AddColumn("order_position", System.Data.DbType.Int32, 0, comments: "Order position of the lookup.")
				.AddColumn("is_default", System.Data.DbType.Boolean, 0, comments: "Indicates a default lookup value used by the application.")
